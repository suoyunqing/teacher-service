...
class CourseServiceTest {
    ...
    @Mock
    CourseRecreationRepository mockCourseRecreationRepository;
    ...
    void shouldSaveDbAndPublishToKafkaWhenCallRecreateCourseGivenValidCourse() {
        ...
        CourseRecreationEntity expectedCourseRecreationEntity = CourseRecreationEntity.builder().courseId("aa").content("xxxx").submissionTime("2020-01-20 08:00:00").build();
        ...
        //Then
        verify(mockCourseRecreationRepository).save(refEq(expectedCourseRecreationEntity));
    ...
    void shouldThrowCoureseNotExistExceptionWhenCallRecreateCourseGivenCourseIdNotExist() {
        ...
        verify(mockCourseRecreationRepository, times(0)).save(any());
    ...
    void shouldThrowExceptionWhenCallRecreateCourseGivenKafkaIsNotAvailable() {
        ...
        verify(mockCourseRecreationRepository, times(1)).save(any());
    }
}